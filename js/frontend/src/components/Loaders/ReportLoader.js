...
import styles from '../../Style/ReportLoaderStyles.module.css'

const ReportLoader = () => {
  return (
    <div className={styles.container_SevMini}>
      <div className={styles.SevMini}>
        <svg width="74" height="90" viewBox="0 0 74 90" fill="none" xmlns="http://www.w3.org/2000/svg" >
          ...
          ></path>
          <path 
            className={styles.strobe_color2}
            d="M63 69.5L65.5 68V71L63 72.5V69.5Z"
            fill="#17e300b4"
          ></path>
          <path
            className={styles.strobe_color4}
            d="M68 66.5L70.5 65V68L68 69.5V66.5Z" fill="#FF715E">
            </path>
          <path
          ...
          <path className={styles.strobe_color2} d="M58 54.5L60.5 53V56L58 57.5V54.5Z" fill="#FF715E"></path>
          <path d="M63 51.5L65.5 50V53L63 54.5V51.5Z" fill="black"></path>
          <path className={styles.strobe_color1} d="M63 51.5L65.5 50V53L63 54.5V51.5Z" fill="#FF715E" ></path>
          <path className={styles.strobe_color6} d="M68 48.5L70.5 47V50L68 51.5V48.5Z" fill="#FF715E"></path>
          <path
          ...
          <path
            className={styles.strobe_color3}
