        ...
        <Box style={{ width: '100%' }} sx={{ mr: -1, color: 'black' }}>
          <Stack direction={'column'}>
            ...
            <Box sx={{ mt: "6px", mx: "10px", p: 2,  background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.06), rgba(255, 255, 255, 0))', backdropFilter: 'blur(25px)', WebkitBackdropFilter: 'blur(25px)', borderRadius: '20px', border: '1px solid rgba(255, 255, 255, 0.18)', boxShadow: '0 8px 32px 0 rgba(0, 0, 0, 0.37)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <UploadComp className={FilesPageStyle.info_panel} userAnalyzeDataCallback={userAnalyzeDataCallback} fallBack={fallBack} Files={rows}/>
            </Box>
            ...
            <Box sx={{ fontSize: "20px", justifyContent: 'center', textAlign: 'center', paddingTop: 1 }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}> <span>Your uploaded pcap files</span> 
              <svg style={{marginLeft: "5px"}} xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" viewBox="0 0 24 24"><mask id="lineMdCloudUploadLoop0"><g fill="#fff"><circle cx="12" cy="10" r="6"></circle><rect width="9" height="7" x="8" y="13"></rect><rect width="15" height="12" x="1" y="8" rx="6"><animate attributeName="x" dur="21s" repeatCount="indefinite" values="1;0;1;2;1"></animate></rect><rect width="13" height="10" x="10" y="10" rx="5"><animate attributeName="x" dur="19s" repeatCount="indefinite" values="10;9;10;11;10"></animate></rect></g><rect width="4" height="5" x="10" y="12"></rect><path d="M12 8L17 13H7L12 8Z"><animateMotion calcMode="linear" dur="1.5s" keyPoints="0;0.25;0.5;0.75;1" keyTimes="0;0.1;0.5;0.8;1" path="M0 0v-1v2z" repeatCount="indefinite"></animateMotion></path></mask><rect width="24" height="24" fill="currentColor" mask="url(#lineMdCloudUploadLoop0)"></rect></svg>            
            </Box>
              {
