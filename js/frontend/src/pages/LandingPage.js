...
const LandingPage = ({ isValidUser }) => {
  ...
  const username_text = String(userObj.username).charAt(0).toUpperCase() + String(userObj.username).slice(1).toLowerCase()
